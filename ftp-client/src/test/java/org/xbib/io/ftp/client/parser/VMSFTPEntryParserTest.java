...
public class VMSFTPEntryParserTest extends FTPParseTestFramework
{
    ...
    public void testParseFieldsOnDirectory() throws Exception {
        ...
        assertNotNull(dir.getTimestamp());
        assertEquals("Tue Jun 02 07:32:04 1998", dir.getTimestamp().format(df));
    ...
    public void testParseFieldsOnFile() throws Exception
    {
        ...
        assertEquals(9 * 512,
                     file.getSize());
        assertNotNull(file.getTimestamp());
        assertEquals("Tue Jun 02 07:32:04 1998", file.getTimestamp().format(df));
    ...
    public void testDefaultPrecision() {
        //testPrecision("1-JUN.LIS;1              9/9           2-JUN-1998 07:32:04  [TRANSLATED]    (RWED,RD,,)",
        //        TimeUnits.SECOND);
    }
    ...
    protected FTPFileEntryParser getParser() {
        ConfigurableFTPFileEntryParserImpl parser = new VMSFTPEntryParser();
        parser.configure(null);
        return parser;
    }
