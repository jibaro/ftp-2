...
public class UnixFTPEntryParserTest extends FTPParseTestFramework {
    ...
    public void testNumericDateFormat()
    {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(2005, Month.APRIL.getValue(), 8, 11, 22, 0, 0, ZoneId.of("UTC"));
    ...
    public void testNET294() {
        ...
        assertEquals(2008, f.getTimestamp().getYear());
    ...
    public void testCorrectGroupNameParsing() {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(ZonedDateTime.now().getYear(),
                Month.MARCH.getValue(), 17, 11, 7, 0, 0, ZoneId.of("UTC"));
        assertEquals(zonedDateTime.getMonth(), f.getTimestamp().getMonth());
        assertEquals(zonedDateTime.getDayOfMonth(), f.getTimestamp().getDayOfMonth());
        assertEquals(zonedDateTime.getHour(), f.getTimestamp().getHour());
        assertEquals(zonedDateTime.getMinute(), f.getTimestamp().getMinute());
        assertEquals(zonedDateTime.getSecond(), f.getTimestamp().getSecond());
    }
    ...
    public void testRecentPrecision() {
        testPrecision("drwxr-xr-x   2 user     group         4096 Mar  2 15:13 zxbox", TimeUnits.MINUTE);
    }

    @Override
    public void testDefaultPrecision() {
        testPrecision("drwxr-xr-x   2 user     group         4096 Mar  2 2014 zxbox", TimeUnits.DAY);
    }
    ...
    public void testParseFieldsOnFileJapaneseYear() throws Exception {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(2003,
                Month.MARCH.getValue(), 2, 0, 0, 0, 0, ZoneId.of("UTC"));
        assertEquals(zonedDateTime, f.getTimestamp());
    }
